		...
		implements UpdateListener, RenderListener
{
	...
	private final CheckboxSetting lockInTrade = new CheckboxSetting(
			...
			"一旦村民学会了出售你想要的书，就自动从村民那里买点东西。这样可以防止村民"
					+ "以后改变它的交易报价。\n\n"
					+ "使用这个功能时，请确保你的背包里至少有24张纸和9颗绿宝石。或者，1本书和"
					+ "64颗绿宝石也可以。",
			false);
	...
	private final FacingSetting facing = FacingSetting
			.withoutPacketSpam("如何面对村民和工作站。\n\n"
					+ "\u00a7lOff\u00a7r - 不要面对村民。会被反作弊插件检测到。\n\n"
					+ "\u00a7lServer-side\u00a7r - 在服务器端面对村民，同时在客户端自由移动相机。\n\n"
					+ "\u00a7lClient-side\u00a7r - 通过在客户端移动相机来面对村民。这是最合法的选项，但"
					+ "可能会让你感到不适。");

	private final SwingHandSetting swingHand =
			new SwingHandSetting("如何挥动手臂与村民和工作站互动。\n\n"
					+ "\u00a7lOff\u00a7r - 不要挥动手臂。会被反作弊插件检测到。\n\n"
					+ "\u00a7lServer-side\u00a7r - 在服务器端挥动手臂，而不在客户端播放动画。\n\n"
					+ "\u00a7lClient-side\u00a7r - 在客户端挥动手臂。这是最合法的选项。");

	private final SliderSetting repairMode = new SliderSetting("修复模式",
			"当你的斧头的耐久度达到给定的阈值时，防止 AutoLibrarian 使用你的斧头，这样你可以在它"
					+ "损坏之前修复它。\n"
					+ "可以从 0 (关闭) 到 100 调整。",
