	...
	implements UpdateListener, RenderListener
{
	private final BlockListSetting naturalBlocks = new BlockListSetting("自然方块",
		"这些方块将被视为自然生成的一部分。\n\n" + "它们将不会被高亮显示为玩家基地。", "minecraft:acacia_leaves",
	...
	private final ColorSetting color =
		new ColorSetting("颜色", "人造方块将用此颜色高亮显示。", Color.RED);
	...
	public void onUpdate()
	{
		...
		else
		{
			...
			if(messageTimer <= 0)
			{
				ChatUtils.warning("BaseFinder 找到了 \u00a7l很多\u00a7r 方块。");
				ChatUtils.message("为防止延迟，它只会显示前10000个方块。");
			}
