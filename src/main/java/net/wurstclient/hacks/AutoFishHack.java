	...
	implements UpdateListener, PacketInputListener, RenderListener
{
	private final EnumSetting<AutoFishHack.BiteMode> biteMode =
		new EnumSetting<>("咬击模式", "\u00a7l声音\u00a7r 模式通过监听咬击声音来检测咬击。"
			+ " 此方法不太准确，但更具抗性" + " 反作弊。请参见 \"Valid range\" 设置。\n\n"
			+ "\u00a7l实体\u00a7r 模式通过检查"
			+ " fishing hook's entity update packet. It's more accurate than"
			+ " 声音方法不太具有抗性。", AutoFishHack.BiteMode.values(),
			AutoFishHack.BiteMode.SOUND);
