	...
	extends EnumSetting<HitboxCheckSetting.HitboxCheck>
{
	...
	{
		super("命中框检查", DESCRIPTION, HitboxCheck.values(), HitboxCheck.OFF);
	}
	...
	// "不稳定" because isSpaceEmpty() is not thread-safe
	...
	{
		OFF("关闭", pos -> true),
		SLOW("慢", HitboxCheckSetting::slowHitboxCheck),
		UNSTABLE("不稳定", HitboxCheckSetting::unstableHitboxCheck);
