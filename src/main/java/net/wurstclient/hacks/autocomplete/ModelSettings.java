...
public final class ModelSettings
{
	public final EnumSetting<OpenAiModel> openAiModel =
		new EnumSetting<>("OpenAI 模型",
			"用于 OpenAI API 调用的模型。\n推荐的模型:\n\n"
				+ "\u00a7lGPT-4o-2024-08-06\u00a7r 是当时最智能的模型之一"
				+ " 在编写时，并且通常会产生最佳的补全。"
				+ " However, it's meant to be an assistant rather than an"
				+ " AutoComplete系统，因此你会看到它有时产生一些奇怪的" + " 补全。\n\n"
				+ "\u00a7lGPT-3.5-Turbo-Instruct\u00a7r 是一个较旧的非聊天模型"
				+ " 基于 GPT-3.5，适用于自动补全任务。",
	...
	public final SliderSetting temperature = new SliderSetting("温度",
		"Controls the model's creativity and randomness. A higher value will"
			+ " 生成更创意但有时不合理的补全，" + " 而较低的值将生成更无聊的补全。",
		1, 0, 2, 0.01, ValueDisplay.DECIMAL);
	
	public final SliderSetting topP = new SliderSetting(
		"Top P", "温度的替代方案。通过只让模型" + " 从最可能的代币中选择来减少其随机性。\n\n"
			+ "值为 100% 将禁用此功能，让模型" + " 从所有代币中选择。",
		1, 0, 1, 0.01, ValueDisplay.PERCENTAGE);
	
	public final SliderSetting presencePenalty = new SliderSetting(
		"存在惩罚", "选择已经在聊天中出现的代币的惩罚" + " 历史。\n\n" + "正值鼓励模型使用同义词并"
			+ " 讨论不同的主题。负值鼓励模型" + " 重复使用同一个单词。",
		0, -2, 2, 0.01, ValueDisplay.DECIMAL);
	
	public final SliderSetting frequencyPenalty = new SliderSetting("频率惩罚",
		"类似于存在惩罚，但基于代币" + " 在聊天历史中出现的频率。\n\n" + "正值鼓励模型使用同义词并"
			+ " 讨论不同的主题。负值鼓励模型" + " 重复现有的聊天消息。",
		0, -2, 2, 0.01, ValueDisplay.DECIMAL);
	
	public final EnumSetting<StopSequence> stopSequence =
		new EnumSetting<>("停止序列",
			"控制 AutoComplete 如何检测聊天消息的结束。\n\n" + "\u00a7l行中断\u00a7r 是默认值，并且推荐"
				+ " 用于大多数语言模型。\n\n" + "\u00a7l下一条消息\u00a7r 与某些"
				+ "代码优化的语言模型一起工作更好，这些模型有" + " 在聊天消息中间插入行中断的倾向。",
	...
	public final TextFieldSetting openaiLegacyEndpoint = new TextFieldSetting(
		"OpenAI旧版端点", "Endpoint for OpenAI's legacy completion API.",
