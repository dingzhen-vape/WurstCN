...
@SearchTags({"kill aura", "ForceField", "force field", "自动点爆水晶", "crystal aura",
	...
	implements UpdateListener, HandleInputListener, RenderListener
{
	...
	private final SliderSetting speedRandMS = new SliderSetting("速度随机化",
		"通过在攻击之间变化延迟来帮助你绕过反作弊插件" + "攻击。\n\n" + "\u00b1100毫秒是 Vulcan 的推荐值。\n\n"
			+ "0 (关闭) 对于 NoCheat+、AAC、Grim、Verus、Spartan 和" + " 经典服务器是合适的。",
	...
	private final CheckboxSetting damageIndicator =
		new CheckboxSetting("伤害指示器", "在目标内渲染一个颜色框，颜色与目标剩余生命值成反比。", true);
