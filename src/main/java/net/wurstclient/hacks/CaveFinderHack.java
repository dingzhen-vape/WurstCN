	...
	implements UpdateListener, RenderListener
{
	private final ChunkAreaSetting area =
		new ChunkAreaSetting("洞穴查找者的搜索区域。", "洞穴查找者的搜索区域。" + "更高的值需要更快的计算机。");
	
	private final SliderSetting limit = new SliderSetting("限制",
		"要显示的最大方块数量。" + "更高的值需要更快的计算机。", 5, 3, 6, 1, ValueDisplay.LOGARITHMIC);
	
	private final ColorSetting color =
		new ColorSetting("颜色", "洞穴将以这种颜色高亮显示。", Color.RED);
	
	private final SliderSetting opacity =
		new SliderSetting("不透明度", "高亮显示的不透明度。" + "0 = 呼吸动画", 0, 0, 1, 0.01,
	...
	private void startCompileVerticesTask()
	{
		...
		{
			ChatUtils.warning(
				"洞穴查找者找到了 \u00a7l大量\u00a7r 的方块！" + " 为了防止延迟，它只会显示最近的 \u00a76"
