...
public final class ZoomOtf extends OtherFeature implements MouseScrollListener
{
	...
	private final CheckboxSetting scroll =
		new CheckboxSetting("使用鼠标滚轮", "如果启用，您可以在" + "缩放时使用鼠标滚轮进一步放大。", true);
	
	private final CheckboxSetting zoomInScreens = new CheckboxSetting("缩放屏幕",
		"如果启用，您也可以在打开聊天窗口、" + "物品栏等屏幕时进行缩放。", false);
	
	private final TextFieldSetting keybind = new TextFieldSetting("快捷键",
		"确定缩放的快捷键。\n\n" + "与其手动编辑此值，您应该进入Wurst" + "选项 -> 缩放并在那里设置。",
