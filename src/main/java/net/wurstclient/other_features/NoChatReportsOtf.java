	...
	implements UpdateListener, ChatInputListener
{
	...
	{
		super("禁用聊天报告", "description.wurst.other_feature.nochatreports");
	...
	public void onReceivedMessage(ChatInputEvent event)
	{
		...
		HoverEvent hoverEvent = new HoverEvent.ShowText(
			Text.literal("原始消息: ").append(originalText));
		
		ChatUtils.component(
			Text.literal("服务器拒绝在没有启用聊天报告的情况下让你聊天。请参阅wurst.wiki/ncr").styled(
