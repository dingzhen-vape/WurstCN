 ...
 *
 * <p>
 * Navigator is not case-sensitive, so for example "合法挖掘光环" and "合法挖掘光环"
 * are treated the same. However, Navigator struggles with spaces and the order
 * of words, for example "合法挖掘光环", "合法挖掘光环" and "合法挖掘光环" are all
 * treated differently.
 *
 * <p>
 ...
 * "合法挖掘光环" and "合法挖掘光环". This is not enforced, but it makes the
 * code easier to read.
 */
