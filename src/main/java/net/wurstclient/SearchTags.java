 ...
 *
 * <p>
 * Navigator is not case-sensitive, so for example "合法挖掘光环" and "nukerlegit"
 * are treated the same. However, Navigator struggles with spaces and the order
 * of words, for example "合法挖掘光环", "Nuker Legit" and "Legit Nuker" are all
 * treated differently.
 *
 * <p>
 ...
 * "合法挖掘光环" and "nuker legit". This is not enforced, but it makes the
 * code easier to read.
 */
