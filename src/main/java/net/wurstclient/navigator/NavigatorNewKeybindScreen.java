...
public class NavigatorNewKeybindScreen extends NavigatorScreen
{
	...
	protected void onResize()
	{
		...
		addDrawableChild(ButtonWidget
			.builder(Text.literal("取消"), b -> WurstClient.MC.setScreen(parent))
	...
	protected void onUpdate()
	{
		...
		if(choosingKey)
		{
			...
			{
				text += "\n\n键: " + selectedKey.replace("key.keyboard.", "");
				String commands =
		...
		float partialTicks)
	{
		...
		// title bar
		context.drawCenteredTextWithShadow(tr, "新建快捷键", middleX, 32, txtColor);
