...
public final class AimAtSetting extends EnumSetting<AimAtSetting.AimAt>
{
	...
	public enum AimAt
	{
		AUTO("自动", "Aims at the closest point of the target's hitbox.",
			AimAtSetting::aimAtClosestPoint),
		
		HEAD("头部", "Aims at the target's eye position.",
			AimAtSetting::aimAtHead),
		
		CENTER("中心", "Aims at the center of the target's hitbox.",
			AimAtSetting::aimAtCenter),
		
		FEET("脚部", "Aims at the bottom of the target's hitbox.",
