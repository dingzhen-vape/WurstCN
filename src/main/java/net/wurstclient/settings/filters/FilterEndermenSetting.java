...
public final class FilterEndermenSetting extends AttackDetectingEntityFilter
{
	...
	{
		return new FilterEndermenSetting("当设置为\u00a7l开\u00a7r时，" + "末影人不会被攻击。 "
			+ "当设置为\u00a7l如果平静\u00a7r时，末影人不会被攻击" + "直到他们先攻击。要注意的是，这个过滤器无法"
			+ "检测末影人是在攻击你还是别人。 " + "当设置为\u00a7l关\u00a7r时，这个过滤器什么都不做，"
			+ "末影人可以被攻击。", selected);
	}
	
	public static FilterEndermenSetting genericVision(Mode selected)
	{
		return new FilterEndermenSetting("当设置为\u00a7l开\u00a7r时，" + "末影人不会被显示。 "
			+ "当设置为\u00a7l如果平静\u00a7r时，末影人不会被显示" + "直到他们攻击某物。 "
			+ "当设置为\u00a7l关\u00a7r时，这个过滤器什么都不做，" + "末影人可以被显示。", selected);
	}
